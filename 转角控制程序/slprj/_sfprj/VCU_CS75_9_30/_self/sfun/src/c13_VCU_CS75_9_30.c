...
static void initialize_c13_VCU_CS75_9_30(SFc13_VCU_CS75_9_30InstanceStruct
  *chartInstance);
static void initialize_params_c13_VCU_CS75_9_30
  (SFc13_VCU_CS75_9_30InstanceStruct *chartInstance);
static void enable_c13_VCU_CS75_9_30(SFc13_VCU_CS75_9_30InstanceStruct
  *chartInstance);
static void disable_c13_VCU_CS75_9_30(SFc13_VCU_CS75_9_30InstanceStruct
  *chartInstance);
static void c13_update_debugger_state_c13_VCU_CS75_9_30
  (SFc13_VCU_CS75_9_30InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_VCU_CS75_9_30
  (SFc13_VCU_CS75_9_30InstanceStruct *chartInstance);
static void set_sim_state_c13_VCU_CS75_9_30(SFc13_VCU_CS75_9_30InstanceStruct
  *chartInstance, const mxArray *c13_st);
static void finalize_c13_VCU_CS75_9_30(SFc13_VCU_CS75_9_30InstanceStruct
  *chartInstance);
static void sf_gateway_c13_VCU_CS75_9_30(SFc13_VCU_CS75_9_30InstanceStruct
  *chartInstance);
static void initSimStructsc13_VCU_CS75_9_30(SFc13_VCU_CS75_9_30InstanceStruct
  *chartInstance);
...
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_emlrt_marshallIn(SFc13_VCU_CS75_9_30InstanceStruct
  *chartInstance, const mxArray *c13_y2, const char_T *c13_identifier);
static real_T c13_b_emlrt_marshallIn(SFc13_VCU_CS75_9_30InstanceStruct
...
static const mxArray *c13_b_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_c_emlrt_marshallIn(SFc13_VCU_CS75_9_30InstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static uint8_T c13_d_emlrt_marshallIn(SFc13_VCU_CS75_9_30InstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_VCU_CS75_9_30, const char_T
  *c13_identifier);
static uint8_T c13_e_emlrt_marshallIn(SFc13_VCU_CS75_9_30InstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_VCU_CS75_9_30InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_VCU_CS75_9_30 = 0U;
}
  ...
  (SFc13_VCU_CS75_9_30InstanceStruct *chartInstance)
{
  ...
  c13_c_hoistedGlobal = chartInstance->c13_is_active_c13_VCU_CS75_9_30;
  ...
  *chartInstance, const mxArray *c13_st)
{
  ...
  *c13_y2 = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u,
    1)), "y2");
  chartInstance->c13_is_active_c13_VCU_CS75_9_30 = c13_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 2)),
     "is_active_c13_VCU_CS75_9_30");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_VCU_CS75_9_30(chartInstance);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_VCU_CS75_9_30InstanceStruct *chartInstance;
  chartInstance = (SFc13_VCU_CS75_9_30InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c13_VCU_CS75_9_30_get_eml_resolved_functions_info(void)
{
  ...
  *c13_identifier)
{
  ...
  c13_y = c13_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_VCU_CS75_9_30), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_VCU_CS75_9_30);
  return c13_y;
}
...
void sf_c13_VCU_CS75_9_30_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_VCU_CS75_9_30_get_autoinheritance_info(void)
{
...
mxArray *sf_c13_VCU_CS75_9_30_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c13_VCU_CS75_9_30_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c13_VCU_CS75_9_30(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"y1\",},{M[1],M[6],T\"y2\",},{M[8],M[0],T\"is_active_c13_VCU_CS75_9_30\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_VCU_CS75_9_30_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc13_VCU_CS75_9_30InstanceStruct *)
...
static void sf_opaque_initialize_c13_VCU_CS75_9_30(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_VCU_CS75_9_30InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_VCU_CS75_9_30((SFc13_VCU_CS75_9_30InstanceStruct*)
    chartInstanceVar);
  initialize_c13_VCU_CS75_9_30((SFc13_VCU_CS75_9_30InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c13_VCU_CS75_9_30(void *chartInstanceVar)
{
  enable_c13_VCU_CS75_9_30((SFc13_VCU_CS75_9_30InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_VCU_CS75_9_30(void *chartInstanceVar)
{
  disable_c13_VCU_CS75_9_30((SFc13_VCU_CS75_9_30InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c13_VCU_CS75_9_30(void *chartInstanceVar)
{
  sf_gateway_c13_VCU_CS75_9_30((SFc13_VCU_CS75_9_30InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_VCU_CS75_9_30(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_VCU_CS75_9_30
    ((SFc13_VCU_CS75_9_30InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_VCU_CS75_9_30();/* state var info */
...
extern void sf_internal_set_sim_state_c13_VCU_CS75_9_30(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c13_VCU_CS75_9_30();/* state var info */
  ...
  set_sim_state_c13_VCU_CS75_9_30((SFc13_VCU_CS75_9_30InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_VCU_CS75_9_30(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_VCU_CS75_9_30(S);
}

static void sf_opaque_set_sim_state_c13_VCU_CS75_9_30(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c13_VCU_CS75_9_30(S, st);
}

static void sf_opaque_terminate_c13_VCU_CS75_9_30(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_VCU_CS75_9_30InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c13_VCU_CS75_9_30((SFc13_VCU_CS75_9_30InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc13_VCU_CS75_9_30((SFc13_VCU_CS75_9_30InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_VCU_CS75_9_30(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_VCU_CS75_9_30(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c13_VCU_CS75_9_30(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_VCU_CS75_9_30(SimStruct *S)
{
  SFc13_VCU_CS75_9_30InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc13_VCU_CS75_9_30InstanceStruct *)utMalloc(sizeof
    (SFc13_VCU_CS75_9_30InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_VCU_CS75_9_30InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_VCU_CS75_9_30;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_VCU_CS75_9_30;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_VCU_CS75_9_30;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_VCU_CS75_9_30;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_VCU_CS75_9_30;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_VCU_CS75_9_30;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_VCU_CS75_9_30;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_VCU_CS75_9_30;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_VCU_CS75_9_30;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_VCU_CS75_9_30;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c13_VCU_CS75_9_30;
...
void c13_VCU_CS75_9_30_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_VCU_CS75_9_30(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_VCU_CS75_9_30(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_VCU_CS75_9_30(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_VCU_CS75_9_30_method_dispatcher.\n"
