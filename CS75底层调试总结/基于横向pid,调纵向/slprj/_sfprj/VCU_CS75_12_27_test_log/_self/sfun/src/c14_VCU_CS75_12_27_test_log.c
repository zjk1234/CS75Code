...
static void initialize_c14_VCU_CS75_12_27_test_log
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance);
static void initialize_params_c14_VCU_CS75_12_27_test_log
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance);
static void enable_c14_VCU_CS75_12_27_test_log
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance);
static void disable_c14_VCU_CS75_12_27_test_log
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance);
static void c14_update_debugger_state_c14_VCU_CS75_12_27_test_log
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_VCU_CS75_12_27_test_log
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance);
static void set_sim_state_c14_VCU_CS75_12_27_test_log
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance, const mxArray
   *c14_st);
static void finalize_c14_VCU_CS75_12_27_test_log
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance);
static void sf_gateway_c14_VCU_CS75_12_27_test_log
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance);
static void initSimStructsc14_VCU_CS75_12_27_test_log
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_emlrt_marshallIn(SFc14_VCU_CS75_12_27_test_logInstanceStruct
  *chartInstance, const mxArray *c14_y, const char_T *c14_identifier);
static real_T c14_b_emlrt_marshallIn(SFc14_VCU_CS75_12_27_test_logInstanceStruct
...
static uint8_T c14_d_emlrt_marshallIn
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance, const mxArray
   *c14_b_is_active_c14_VCU_CS75_12_27_test_log, const char_T *c14_identifier);
static uint8_T c14_e_emlrt_marshallIn
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance, const mxArray
   *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void init_dsm_address_info(SFc14_VCU_CS75_12_27_test_logInstanceStruct
  *chartInstance);
  ...
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_VCU_CS75_12_27_test_log = 0U;
}
  ...
  (SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance)
{
  ...
  c14_b_hoistedGlobal = chartInstance->c14_is_active_c14_VCU_CS75_12_27_test_log;
   ...
   *c14_st)
{
  ...
  *c14_y = c14_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c14_u,
    0)), "y");
  chartInstance->c14_is_active_c14_VCU_CS75_12_27_test_log =
    c14_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c14_u, 1)),
    "is_active_c14_VCU_CS75_12_27_test_log");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_VCU_CS75_12_27_test_log(chartInstance);
  ...
  *c14_inData)
{
  ...
  const mxArray *c14_y = NULL;
  SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance;
  chartInstance = (SFc14_VCU_CS75_12_27_test_logInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c14_VCU_CS75_12_27_test_log_get_eml_resolved_functions_info
  (void)
{
   ...
   *c14_b_is_active_c14_VCU_CS75_12_27_test_log, const char_T *c14_identifier)
{
  ...
  c14_y = c14_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_VCU_CS75_12_27_test_log), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_VCU_CS75_12_27_test_log);
  return c14_y;
}
...
void sf_c14_VCU_CS75_12_27_test_log_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c14_VCU_CS75_12_27_test_log_get_autoinheritance_info(void)
{
...
mxArray *sf_c14_VCU_CS75_12_27_test_log_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c14_VCU_CS75_12_27_test_log_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c14_VCU_CS75_12_27_test_log(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c14_VCU_CS75_12_27_test_log\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_VCU_CS75_12_27_test_log_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c14_VCU_CS75_12_27_test_log(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_VCU_CS75_12_27_test_logInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c14_VCU_CS75_12_27_test_log
    ((SFc14_VCU_CS75_12_27_test_logInstanceStruct*) chartInstanceVar);
  initialize_c14_VCU_CS75_12_27_test_log
    ((SFc14_VCU_CS75_12_27_test_logInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c14_VCU_CS75_12_27_test_log(void *chartInstanceVar)
{
  enable_c14_VCU_CS75_12_27_test_log
    ((SFc14_VCU_CS75_12_27_test_logInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c14_VCU_CS75_12_27_test_log(void *chartInstanceVar)
{
  disable_c14_VCU_CS75_12_27_test_log
    ((SFc14_VCU_CS75_12_27_test_logInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c14_VCU_CS75_12_27_test_log(void *chartInstanceVar)
{
  sf_gateway_c14_VCU_CS75_12_27_test_log
    ((SFc14_VCU_CS75_12_27_test_logInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c14_VCU_CS75_12_27_test_log
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_VCU_CS75_12_27_test_log
    ((SFc14_VCU_CS75_12_27_test_logInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c14_VCU_CS75_12_27_test_log();/* state var info */
...
extern void sf_internal_set_sim_state_c14_VCU_CS75_12_27_test_log(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c14_VCU_CS75_12_27_test_log();/* state var info */
  ...
  set_sim_state_c14_VCU_CS75_12_27_test_log
    ((SFc14_VCU_CS75_12_27_test_logInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c14_VCU_CS75_12_27_test_log
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c14_VCU_CS75_12_27_test_log(S);
}

static void sf_opaque_set_sim_state_c14_VCU_CS75_12_27_test_log(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c14_VCU_CS75_12_27_test_log(S, st);
}

static void sf_opaque_terminate_c14_VCU_CS75_12_27_test_log(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_VCU_CS75_12_27_test_logInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c14_VCU_CS75_12_27_test_log
      ((SFc14_VCU_CS75_12_27_test_logInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc14_VCU_CS75_12_27_test_log
    ((SFc14_VCU_CS75_12_27_test_logInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_VCU_CS75_12_27_test_log(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c14_VCU_CS75_12_27_test_log(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c14_VCU_CS75_12_27_test_log(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_VCU_CS75_12_27_test_log(SimStruct *S)
{
  SFc14_VCU_CS75_12_27_test_logInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc14_VCU_CS75_12_27_test_logInstanceStruct *)utMalloc(sizeof
    (SFc14_VCU_CS75_12_27_test_logInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_VCU_CS75_12_27_test_logInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c14_VCU_CS75_12_27_test_log;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c14_VCU_CS75_12_27_test_log;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c14_VCU_CS75_12_27_test_log;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c14_VCU_CS75_12_27_test_log;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c14_VCU_CS75_12_27_test_log;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c14_VCU_CS75_12_27_test_log;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c14_VCU_CS75_12_27_test_log;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c14_VCU_CS75_12_27_test_log;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_VCU_CS75_12_27_test_log;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_VCU_CS75_12_27_test_log;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c14_VCU_CS75_12_27_test_log;
...
void c14_VCU_CS75_12_27_test_log_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_VCU_CS75_12_27_test_log(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_VCU_CS75_12_27_test_log(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_VCU_CS75_12_27_test_log(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_VCU_CS75_12_27_test_log_method_dispatcher.\n"
