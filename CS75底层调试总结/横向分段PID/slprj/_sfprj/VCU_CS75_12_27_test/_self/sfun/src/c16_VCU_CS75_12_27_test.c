...
static void initialize_c16_VCU_CS75_12_27_test
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance);
static void initialize_params_c16_VCU_CS75_12_27_test
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance);
static void enable_c16_VCU_CS75_12_27_test
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance);
static void disable_c16_VCU_CS75_12_27_test
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance);
static void c16_update_debugger_state_c16_VCU_CS75_12_27_test
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_VCU_CS75_12_27_test
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance);
static void set_sim_state_c16_VCU_CS75_12_27_test
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance, const mxArray *c16_st);
static void finalize_c16_VCU_CS75_12_27_test
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance);
static void sf_gateway_c16_VCU_CS75_12_27_test
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance);
static void initSimStructsc16_VCU_CS75_12_27_test
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance);
...
static const mxArray *c16_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static real_T c16_emlrt_marshallIn(SFc16_VCU_CS75_12_27_testInstanceStruct
  *chartInstance, const mxArray *c16_y, const char_T *c16_identifier);
static real_T c16_b_emlrt_marshallIn(SFc16_VCU_CS75_12_27_testInstanceStruct
...
static const mxArray *c16_b_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_c_emlrt_marshallIn(SFc16_VCU_CS75_12_27_testInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void c16_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static uint8_T c16_d_emlrt_marshallIn(SFc16_VCU_CS75_12_27_testInstanceStruct
  *chartInstance, const mxArray *c16_b_is_active_c16_VCU_CS75_12_27_test, const
  char_T *c16_identifier);
static uint8_T c16_e_emlrt_marshallIn(SFc16_VCU_CS75_12_27_testInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_VCU_CS75_12_27_testInstanceStruct
  *chartInstance);
  ...
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_VCU_CS75_12_27_test = 0U;
}
  ...
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance)
{
  ...
  c16_b_hoistedGlobal = chartInstance->c16_is_active_c16_VCU_CS75_12_27_test;
  ...
  (SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance, const mxArray *c16_st)
{
  ...
  *c16_y = c16_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c16_u,
    0)), "y");
  chartInstance->c16_is_active_c16_VCU_CS75_12_27_test = c16_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 1)),
     "is_active_c16_VCU_CS75_12_27_test");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_VCU_CS75_12_27_test(chartInstance);
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance;
  chartInstance = (SFc16_VCU_CS75_12_27_testInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c16_VCU_CS75_12_27_test_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c16_identifier)
{
  ...
  c16_y = c16_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_VCU_CS75_12_27_test), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_VCU_CS75_12_27_test);
  return c16_y;
}
...
void sf_c16_VCU_CS75_12_27_test_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c16_VCU_CS75_12_27_test_get_autoinheritance_info(void)
{
...
mxArray *sf_c16_VCU_CS75_12_27_test_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c16_VCU_CS75_12_27_test_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c16_VCU_CS75_12_27_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c16_VCU_CS75_12_27_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_VCU_CS75_12_27_test_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc16_VCU_CS75_12_27_testInstanceStruct *)
...
static void sf_opaque_initialize_c16_VCU_CS75_12_27_test(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc16_VCU_CS75_12_27_testInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c16_VCU_CS75_12_27_test
    ((SFc16_VCU_CS75_12_27_testInstanceStruct*) chartInstanceVar);
  initialize_c16_VCU_CS75_12_27_test((SFc16_VCU_CS75_12_27_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c16_VCU_CS75_12_27_test(void *chartInstanceVar)
{
  enable_c16_VCU_CS75_12_27_test((SFc16_VCU_CS75_12_27_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c16_VCU_CS75_12_27_test(void *chartInstanceVar)
{
  disable_c16_VCU_CS75_12_27_test((SFc16_VCU_CS75_12_27_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c16_VCU_CS75_12_27_test(void *chartInstanceVar)
{
  sf_gateway_c16_VCU_CS75_12_27_test((SFc16_VCU_CS75_12_27_testInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c16_VCU_CS75_12_27_test
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_VCU_CS75_12_27_test
    ((SFc16_VCU_CS75_12_27_testInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c16_VCU_CS75_12_27_test();/* state var info */
...
extern void sf_internal_set_sim_state_c16_VCU_CS75_12_27_test(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c16_VCU_CS75_12_27_test();/* state var info */
  ...
  set_sim_state_c16_VCU_CS75_12_27_test((SFc16_VCU_CS75_12_27_testInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c16_VCU_CS75_12_27_test(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c16_VCU_CS75_12_27_test(S);
}

static void sf_opaque_set_sim_state_c16_VCU_CS75_12_27_test(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c16_VCU_CS75_12_27_test(S, st);
}

static void sf_opaque_terminate_c16_VCU_CS75_12_27_test(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_VCU_CS75_12_27_testInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c16_VCU_CS75_12_27_test((SFc16_VCU_CS75_12_27_testInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc16_VCU_CS75_12_27_test((SFc16_VCU_CS75_12_27_testInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_VCU_CS75_12_27_test(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c16_VCU_CS75_12_27_test
      ((SFc16_VCU_CS75_12_27_testInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c16_VCU_CS75_12_27_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c16_VCU_CS75_12_27_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_VCU_CS75_12_27_test(SimStruct *S)
{
  SFc16_VCU_CS75_12_27_testInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc16_VCU_CS75_12_27_testInstanceStruct *)utMalloc(sizeof
    (SFc16_VCU_CS75_12_27_testInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_VCU_CS75_12_27_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_VCU_CS75_12_27_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_VCU_CS75_12_27_test;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_VCU_CS75_12_27_test;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c16_VCU_CS75_12_27_test;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c16_VCU_CS75_12_27_test;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_VCU_CS75_12_27_test;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_VCU_CS75_12_27_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_VCU_CS75_12_27_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_VCU_CS75_12_27_test;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_VCU_CS75_12_27_test;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_VCU_CS75_12_27_test;
...
void c16_VCU_CS75_12_27_test_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_VCU_CS75_12_27_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_VCU_CS75_12_27_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_VCU_CS75_12_27_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_VCU_CS75_12_27_test_method_dispatcher.\n"
